...
class Category:
    ...
    def __post_init__(self) -> None:
        self.name = require_text(self.name, field="name", max_length=CATEGORY_NAME_MAX_LENGTH)

    @classmethod
    def create(cls, name: str, slug: Slug | None = None) -> Self:
        clean_name = require_text(name, field="name", max_length=CATEGORY_NAME_MAX_LENGTH)
    ...
    def update(self, name: str, slug: Slug | None = None) -> None:
        self.name = require_text(name, field="name", max_length=CATEGORY_NAME_MAX_LENGTH)
